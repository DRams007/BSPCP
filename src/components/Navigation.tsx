      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {navigationItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className={`font-source text-sm font-medium transition-colors duration-200 ${
                  isActive(item.href)
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-source font-medium">
              Get Help Now
            </Button>
          </div>
