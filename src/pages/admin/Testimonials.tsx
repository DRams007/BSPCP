...
const Testimonials = () => {
  ...
  const [testimonials, setTestimonials] = useState([
    {
      id: 1,
      name: "Sarah Lebotse",
      email: "sarah.lebotse@example.com",
      role: "Client",
    ...
    },
    {
      id: 2,
      name: "Michael Serame",
      email: "michael.serame@example.com",
  ...
  const handleStatusChange = (id: number, newStatus: string) => {
    ...
    const action = newStatus === "Pending" && testimonial?.status === "Approved"
      ? "unapproved"
      : newStatus === "Approved"
      ? "approved"
      : newStatus === "Rejected"
