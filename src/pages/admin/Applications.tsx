...
const Applications = () => {
  ...
  useEffect(() => {
    ...
    const handlePaymentVerified = () => fetchApplications();
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            className={`${application.membershipType === 'professional'
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <Badge
                          className={`text-xs ${application.payment_status === 'verified'
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
                              ...
                              <Card>
                                ...
                                <CardContent className="space-y-2 text-sm">
                                  ...
                                  <div><strong>Application Type:</strong>
                                    <Badge
                                      className={`ml-2 ${selectedApplication.membershipType === 'professional'
                                        ? 'bg-purple-100 text-purple-800'
                                        : 'bg-blue-100 text-blue-800'
                                        }`}
                                    >
                              ...
                              <Card>
                                ...
                                <CardContent className="space-y-3 text-sm">
                                  ...
                                  {/* Session Types */}
                                  {selectedApplication.session_types && Array.isArray(selectedApplication.session_types) && selectedApplication.session_types.length > 0 && (
                                    <div>
                                      <strong>Session Types:</strong>
                                      <div className="flex flex-wrap gap-1 mt-1">
                                        {selectedApplication.session_types.map((type, index) => (
                                ...
                                <Card className="md:col-span-2">
                                  <CardHeader className="pb-3">
                                    <CardTitle className="text-lg flex items-center justify-between">
                                      ...
                                      <Badge
                                        className={`${selectedApplication.payment_status === 'verified'
                                          ? 'bg-green-100 text-green-800'
                      ...
                      <TableCell>
                        <div className="text-sm">
                          {application.payment_status ? (
                            <Badge
                              className={`${application.payment_status === 'verified'
                                ? 'bg-green-100 text-green-800'
                                : application.payment_status === 'uploaded'
                                  ? 'bg-blue-100 text-blue-800'
                                  : application.payment_status === 'rejected'
                                    ...
                                    <Card className="md:col-span-2">
                                      ...
                                      <CardContent>
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                          {/* Find and display payment proof document from documents array - PLACE ON LEFT */}
                                          {(() => {
                                            const paymentProofDocs = selectedApplication.documents.filter(doc => doc.name.startsWith('Proof of Payment'));

                                            if (paymentProofDocs.length === 0) return null;

                                            return (
                                              <div className="space-y-3">
                                                {paymentProofDocs.map((doc, idx) => (
                                                  <div key={idx} className="flex items-center gap-4 p-4 bg-blue-50 rounded-lg border">
                                                    <Receipt className="w-12 h-12 text-blue-500" />
                                                    <div className="flex-1">
                                                    ...
                                                    {doc.url && (
                                                      <Button
                                                        ...
                                                        onClick={() => {
                                                          ...
                                                          toast({
                                                            title: "Document Opened",
                                                            description: `${doc.name} opened in a new tab.`,
                                                          });
                                                        }}
                                                      >
                                                        <Download className="w-4 h-4" />
                                                        ...
                                                        <CardContent className="p-4">
                                                          <div className="flex items-center justify-between">
                                                            <div className="flex items-center space-x-3">
                                                              <Badge
                                                                className={`${entry.action === 'payment_verified'
                                                                  ? 'bg-green-100 text-green-800'
                                                            ...
                                                            <div className="flex items-center space-x-2">
                                                              ...
                                                              {entry.reason && (
                                                                <span className={`text-sm px-2 py-1 rounded text-left ${entry.action === 'payment_rejected'
