...
import { BookOpen, Heart, Phone, Video, Download, ExternalLink, FileText, Headphones, Globe, Users, AlertCircle, Clock, Search, Filter, Home, ChevronRight, Play, Star, Calendar, Mail, HelpCircle, Brain, TreePine, Shield, Lightbulb, GraduationCap, Briefcase, CheckCircle } from 'lucide-react';
const Resources = () => {
  const resourceCategories = [{
    ...
    resources: ['Understanding Depression & Anxiety', 'Managing Stress & Burnout', 'Recognizing Mental Health Warning Signs', 'Supporting Someone with Mental Health Issues']
  }, {
    icon: FileText,
    title: 'Self-Help Tools & Worksheets',
    description: 'Downloadable resources to support your mental health journey',
    color: 'bg-terracotta/10 text-terracotta',
    resources: ['Mood Tracking Sheets', 'Anxiety Management Worksheets', 'Communication Skills Templates', 'Goal Setting & Progress Tracking']
  }, {
    icon: AlertCircle,
    ...
    resources: ['CPD Training Materials', 'Ethical Guidelines', 'Research Publications', 'Best Practice Guidelines']
  }, {
    icon: BookOpen,
    title: 'Research & Publications',
    description: 'Latest research findings and professional publications',
    color: 'bg-green-100 text-green-600',
    resources: ['BSPCP Journal Articles', 'Research Reports', 'Case Studies', 'Policy Recommendations']
  }];
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {resourceCategories.map((category, index) => <Card key={index} className="group hover:shadow-soft transition-all duration-300">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-2 mb-6">
                    {category.resources.map((resource, resourceIndex) => <div key={resourceIndex} className="flex items-center gap-2 text-sm">
      ...
      <section className="py-20 bg-red-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {emergencyContacts.map((contact, index) => <Card key={index} className="border-red-200">
          ...
          <Card className="bg-red-100 border-red-200">
            <CardContent className="p-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                {['Thoughts of self-harm or suicide', 'Severe depression or anxiety', 'Substance abuse crisis', 'Domestic violence situations', 'Psychotic episodes', 'Severe panic attacks'].map((situation, index) => <div key={index} className="flex items-center gap-2">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {selfHelpTools.map((tool, index) => <Card key={index} className="group hover:shadow-soft transition-all duration-300">
                <CardContent className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <Card>
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  {['CPD Training Materials & Workshops', 'Evidence-Based Practice Guidelines', 'Ethical Decision-Making Resources', 'Supervision & Mentorship Programs', 'Professional Development Webinars', 'Peer Learning & Discussion Groups'].map((resource, index) => <div key={index} className="flex items-center gap-3">
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  {['Student Membership Benefits', 'Internship & Placement Opportunities', 'Career Guidance & Mentorship', 'Academic Resources & Study Materials', 'Professional Networking Events', 'Research & Publication Opportunities'].map((resource, index) => <div key={index} className="flex items-center gap-3">
          ...
          <Card className="bg-gradient-warm text-white">
            <CardContent className="p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                <div className="flex-1">
                  <input type="email" placeholder="Enter your email address" className="w-full px-4 py-3 rounded-lg border-0 bg-white/20 text-white placeholder-cream/70 backdrop-blur-sm" />
                </div>
                <Button size="lg" className="bg-white text-primary hover:bg-cream">
                  Subscribe
                </Button>
